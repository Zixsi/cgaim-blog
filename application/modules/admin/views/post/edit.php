		...
		<div class="col-xs-12">
			...
			<form action="./" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="meta_keywords" id="fmeta_keywords" class="form-control" placeholder="анимация, графика и тд" value="<?=htmlspecialchars_decode(set_value('meta_keywords', $item['meta_keywords'], true))?>">
				</div>
				<div class="form-group">
					<label for="fmeta_description">Meta Description</label>
					<input type="text" name="meta_description" id="fmeta_description" class="form-control" placeholder="" value="<?=htmlspecialchars_decode(set_value('meta_description', $item['meta_description'], true))?>">
				</div>
				<?if($tags):?>
					<div class="form-group">
